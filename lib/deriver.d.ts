...
export declare type Deriver = {
     ...
     * @param advance
     */
    expressionBuilder(type: ts.Type, advance: (t: ts.Type, step: D.ContextStep) => D.Derivate<ts.Expression>): D.Derivate<ts.Expression>;
    /**
     ...
     * @param type
     */
    symbolRepresentsTcForType?(symbol: ts.Symbol, type: ts.Type): D.Derivate<boolean>;
    /**
